...
use router_off_chain_common::xdr::decode_contract_id;

// Feed arbitrary byte sequences to the shared strkey decoder.
//
...
// This exercises the shared implementation used by both the api-server and the
// metrics exporter.
fuzz_target!(|data: &[u8]| {
